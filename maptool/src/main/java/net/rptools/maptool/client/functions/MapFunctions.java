...
public class MapFunctions extends AbstractFunction {
	...
	public static boolean isMapFile(String filename) {
		return filename != null
				&& (filename.toLowerCase().endsWith(AppConstants.MAP_FILE_EXTENSION) || filename.toLowerCase().endsWith(AppConstants.MAP_FILE_EXTENSION + AppConstants.PHP_FILE_EXTENSION));
	}
}
